        ...
        $(document).ready(function () {
            ...
            function drawImage(url, x, y, w, h) {
                ...
                img.onload = function () {
                    ...
                    var videoWidth = $('#photo-booth-frame').width();
            ...
            var initialTop = 49;
            var initialLeft = 26;
            var verticalOffset = 326;  // ระยะที่กรอบรูปจะเลื่อนไปในแต่ละครั้ง
            ...
            function addRectangle() {
                ...
                var top = initialTop + ((rectangleCount - 1) * verticalOffset);
                var left = initialLeft;

                // เพิ่มกรอบรูปลงในพื้นที่กำหนด
                $('#photo-booth-frame').append(newRectangle);
                $('#box' + rectangleCount).css({
                    top: top, // ตำแหน่งแนวตั้ง
                    left: left, // ตำแหน่งแนวนอน
                    width: width,
                    height: height
                });
            ...
            // $(document).ready(function() {
            //     addRectangle(49, 30);   // กรอบที่ 1
            //     addRectangle(375, 24);    // กรอบที่ 2
            //     // addRectangle(300, 25);  // กรอบที่ 3
            //     // addRectangle(350, 25);   // กรอบที่ 4
            // });
